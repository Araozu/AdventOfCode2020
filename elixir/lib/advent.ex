defmodule Advent do
  ...
  def obtenerRutaArchivo(dia, _) do
    ndiaR = Integer.to_string(dia)
    ndia = if String.length(ndiaR) == 1 do "0#{ndiaR}" else ndiaR end

    "/home/araozu/Programacion/AdventOfCode2020/inputs/input_#{ndia}_test.txt"
  end
  ...
  def main do
    ...
    bench(fn -> Advent.Dia10.puzzle(obtenerRutaArchivo(10)) end)
  end
end
